...
public class MenuAdministrador extends Hospital {
    ...
    private ArrayList<String> obtenerDatosComun(Rol rol) {
        ...
        System.out.println(String.format("Ingresa el número de teléfono del %s: ", tipoUsuario));
        String numeroTelefono = read.nextLine();
        datosEnComun.add(numeroTelefono);
         if (!validarTelefonoUnico(numeroTelefono)) {
            System.out.println("El numero telefonico ya está registrado. No se puede registrar.");
            return null;
        }

        System.out.println(String.format("Ingresa el correo del %s: ", tipoUsuario));
        String email = read.nextLine();
        datosEnComun.add(email);
        if (!validarCorreoUnico(email)) {
            System.out.println("El correo ya está registrado. No se puede registrar.");
            return null;
        }
